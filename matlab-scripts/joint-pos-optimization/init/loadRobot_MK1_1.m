% LOAD ROBOT_MK1_1 load the iRonCub-Mk1_1 robot model and set the robot 
%                  initial pose w.r.t. the inertial frame.
%
...
Config.initJointPosOpt.jetIntensities_init = [100; 100; 120; 120]; %[N]
