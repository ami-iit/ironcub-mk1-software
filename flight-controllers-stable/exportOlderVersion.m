...
%  the default version is MATLAB 2020a. IF YOU OWE A MATLAB VERSION GREATER 
%  THAN 2020a, REMEMBER TO EXPORT ALL MODELS TO THE DEFAULT SUPPORTED 
...
matlabVer_list     = {'R2020a', 'R2020b', 'R2021a', 'R2021b'};

% associated Simulink version
simulinkVer_number = {'10.1', '10.2', '10.3', '10.4'};
...
mdlVer_list = {'R2020A_MDL', 'R2020B_MDL', 'R2021A_MDL', 'R2021B_MDL'};
slxVer_list = {'R2020A_SLX', 'R2020B_SLX', 'R2021A_SLX', 'R2021B_SLX'};
