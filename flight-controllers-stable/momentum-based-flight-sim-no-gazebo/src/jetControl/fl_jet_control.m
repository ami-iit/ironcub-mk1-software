function [throttle, error]  = fl_jet_control(jets, jets_dot, jets_dot_des, Config, integral_err)
...
for i=1:4
    ...
    f_jet_i = jetModel.get_f(x(i,:), Config.jet.coeff(i,:));
    g_jet_i = jetModel.get_g(x(i,:), Config.jet.coeff(i,:));
