function [throttle, error]  = fl_jets_control_des_jets(jets, jets_dot, jets_des, Config, integral_err)
...
for i=1:4
    ...
    v_i = - (Config.fl.KP(i)*error(i) + Config.fl.KD(i)*jets_dot(i) + f_jet_i + Config.fl.KI(i)*integral_err(i))/g_jet_i;
