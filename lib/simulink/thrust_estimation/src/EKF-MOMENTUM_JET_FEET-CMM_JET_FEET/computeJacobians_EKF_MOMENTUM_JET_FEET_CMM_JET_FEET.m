function [A,C] = computeJacobians_EKF_MOMENTUM_JET_FEET_CMM_JET_FEET(x, input_jets, Amatrix, GI_X_LF, GI_X_RF, coefficients_P100, coefficients_P220)
    ...
    C = [zeros(6,4), zeros(6,4), eye(6),        zeros(6),     zeros(6); ...
        eye(4),         zeros(4),    zeros(4,6), zeros(4,6), zeros(4,6); ...
